...
// Update settings logic can go here
...
<head>
    ...
    <title>Paramètres - BTC Plateforme d'Apprentissage</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a class="nav-link" href="settings.php">Paramètres</a></li>
